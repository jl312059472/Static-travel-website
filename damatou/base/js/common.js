...
function BuildHtml(RP,ver,catchtime,i){
		...
		$.ajax({
			type: "GET",
			url:"http://demo.mobanzhongxin.com/4242/base/js/index.php",
			data: i+".html&htmlversion="+ver+"&htmlcatchtime="+catchtime,
			success: function(msg){
				if(msg=="NOCATCH"){
					if(i=='index'){
						window.location='http://demo.mobanzhongxin.com/4242/base/js/index.php';
					}else{
						window.location='http://demo.mobanzhongxin.com/4242/base/js/?'+i+'.html';
					}
				}
